...
T = TypeVar("T", bound="SubscriberSubscriberSubscriptionsRcPromoProCatMonthly")


@_attrs_define
class SubscriberSubscriberSubscriptionsRcPromoProCatMonthly:
    """
    Attributes:
        auto_resume_date (Union[Unset, Any]):
        billing_issues_detected_at (Union[Unset, Any]):
        expires_date (Union[Unset, str]):  Example: 2019-08-26T01:02:16Z.
        grace_period_expires_date (Union[Unset, Any]):
        is_sandbox (Union[Unset, bool]):  Default: True.
        original_purchase_date (Union[Unset, str]):  Example: 2019-07-26T01:02:16Z.
        ownership_type (Union[Unset, str]):  Example: FAMILY_SHARED.
        period_type (Union[Unset, str]):  Example: normal.
        purchase_date (Union[Unset, str]):  Example: 2019-07-26T01:02:16Z.
        refunded_at (Union[Unset, Any]):
        store (Union[Unset, str]):  Example: promotional.
        unsubscribe_detected_at (Union[Unset, Any]):
    """
    ...
    unsubscribe_detected_at: Union[Unset, Any] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subscriber_subscriber_subscriptions_rc_promo_pro_cat_monthly = cls(
        ...
        subscriber_subscriber_subscriptions_rc_promo_pro_cat_monthly.additional_properties = d
        return subscriber_subscriber_subscriptions_rc_promo_pro_cat_monthly
