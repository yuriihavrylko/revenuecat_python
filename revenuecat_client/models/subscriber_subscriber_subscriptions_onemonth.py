...
T = TypeVar("T", bound="SubscriberSubscriberSubscriptionsOnemonth")


@_attrs_define
class SubscriberSubscriberSubscriptionsOnemonth:
    """
    Attributes:
        auto_resume_date (Union[Unset, Any]):
        billing_issues_detected_at (Union[Unset, Any]):
        expires_date (Union[Unset, str]):  Example: 2019-06-17T22:47:55Z.
        ...
        purchase_date (Union[Unset, str]):  Example: 2019-06-17T22:42:55Z.
        refunded_at (Union[Unset, Any]):
        store (Union[Unset, str]):  Example: app_store.
        unsubscribe_detected_at (Union[Unset, str]):  Example: 2019-06-17T22:48:38Z.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subscriber_subscriber_subscriptions_onemonth = cls(
        ...
        subscriber_subscriber_subscriptions_onemonth.additional_properties = d
        return subscriber_subscriber_subscriptions_onemonth
