...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/projects/{project_id}/subscriptions/{subscription_id}/actions/cancel",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Cancel an active RevenueCat Billing subscription
     ...
     Cancel an active RevenueCat Billing subscription. The customer will lose access to the associated
