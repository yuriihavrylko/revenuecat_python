...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/projects/{project_id}/subscriptions/{subscription_id}/actions/refund",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Refund an active RevenueCat Billing subscription
     ...
     Cancel a RevenueCat Billing subscription by refunding the most recent payment. The customer will
