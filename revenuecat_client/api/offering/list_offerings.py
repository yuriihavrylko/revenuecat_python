...
def _get_kwargs(
    ...
    *,
    ...
    expand: Union[Unset, List[ListOfferingsExpandItem]] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
) -> Optional[Union[Any, OfferingList]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, OfferingList]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        expand (Union[Unset, List[ListOfferingsExpandItem]]):
