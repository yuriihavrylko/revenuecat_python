...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/customers/{customer_id}/active_entitlements",
        "params": params,
    }
...
) -> Optional[Union[Any, CustomerActiveEntitlementList]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CustomerActiveEntitlementList]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CustomerActiveEntitlementList]
    """
