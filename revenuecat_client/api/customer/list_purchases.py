...
def _get_kwargs(
    ...
    customer_id: str,
    *,
    environment: Union[Unset, ListPurchasesEnvironment] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/customers/{customer_id}/purchases",
        "params": params,
    }
...
) -> Optional[Union[Any, PurchaseList]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PurchaseList]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        environment (Union[Unset, ListPurchasesEnvironment]):
