...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/customers/{customer_id}/attributes",
        "params": params,
    }
...
) -> Optional[Union[Any, CustomerAttributeList]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CustomerAttributeList]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CustomerAttributeList]
    """
