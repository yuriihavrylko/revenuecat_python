...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/packages/{package_id}/products",
        "params": params,
    }
...
) -> Optional[Union[Any, ProductsFromPackageList]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProductsFromPackageList]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ProductsFromPackageList]
    """
